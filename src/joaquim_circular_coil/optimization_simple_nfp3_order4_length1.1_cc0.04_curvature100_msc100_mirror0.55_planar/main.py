...
max_mode_array = [1]*0 + [2]*2 + [3]*1 + [4]*0 + [5]*0 + [6]*0
nmodes_coils = 4
...
vmec = Vmec(vmec_input_filename, mpi=mpi, verbose=vmec_verbose, nphi=nphi_VMEC, ntheta=ntheta_VMEC, range_surface='full torus' if use_extra_coils else ('field period'))
surf = vmec.boundary
